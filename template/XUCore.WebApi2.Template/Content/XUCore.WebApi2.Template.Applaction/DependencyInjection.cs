...
using XUCore.WebApi2.Template.DbService;
        ...
        public static IServiceCollection AddApplication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.AddDescriptions(typeof(DependencyInjection),
                        "XUCore.WebApi2.Template.Applaction.xml",
                        "XUCore.WebApi2.Template.Persistence.xml",
                        "XUCore.WebApi2.Template.DbService.xml",
                        "XUCore.WebApi2.Template.Core.xml");
