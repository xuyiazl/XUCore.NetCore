# XUCore.WebApi2.Template

XUCore.WebApi2.Template（只使用插件化的框架，不使用集成式框架）
...
dotnet new --install XUCore.WebApi2.Template::2.0.3
...
dotnet new xucore-WebApi2-template -n MyTest -o .

```

这里的 `xucore-WebApi2-template` 是使用模板短名称。
