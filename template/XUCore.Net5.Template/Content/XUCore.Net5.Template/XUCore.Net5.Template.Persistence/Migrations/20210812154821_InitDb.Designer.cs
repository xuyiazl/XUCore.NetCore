...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.MenuEntity", b =>
                {
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.RoleEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.RoleMenuEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.UserRoleEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.User.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.User.UserLoginRecordEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Events.StoredEvent", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.RoleMenuEntity", b =>
                {
                    b.HasOne("XUCore.Net5.Template.Domain.Core.Entities.Auth.MenuEntity", "Menu")
                        .WithMany("RoleMenus")
                        .HasForeignKey("MenuId")
                        .HasConstraintName("FK_Menu_RoleMenu")
                        .IsRequired();

                    b.HasOne("XUCore.Net5.Template.Domain.Core.Entities.Auth.RoleEntity", "Role")
                        .WithMany("RoleMenus")
            ...
            modelBuilder.Entity("XUCore.Net5.Template.Domain.Core.Entities.Auth.UserRoleEntity", b =>
                {
                    ...
                    b.HasOne("XUCore.Net5.Template.Domain.Core.Entities.User.UserEntity", "User")
                        .WithMany("UserRoles")
