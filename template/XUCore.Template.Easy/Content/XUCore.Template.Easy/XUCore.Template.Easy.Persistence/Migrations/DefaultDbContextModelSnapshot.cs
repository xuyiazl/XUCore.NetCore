...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminMenuEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminRoleMenuEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminUserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminUserLoginRecordEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminUserRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminRoleMenuEntity", b =>
                {
                    b.HasOne("XUCore.Template.Easy.Persistence.Entities.Admin.AdminMenuEntity", "Menus")
                        .WithMany("RoleMenus")
                        .HasForeignKey("MenuId")
                        .HasConstraintName("FK_AdminAuthMenus_AdminAuthRoleMenus")
                        .IsRequired();

                    b.HasOne("XUCore.Template.Easy.Persistence.Entities.Admin.AdminRoleEntity", "Role")
                        .WithMany("RoleMenus")
            ...
            modelBuilder.Entity("XUCore.Template.Easy.Persistence.Entities.Admin.AdminUserLoginRecordEntity", b =>
                {
                    b.HasOne("XUCore.Template.Easy.Persistence.Entities.Admin.AdminUserEntity", "AdminUser")
