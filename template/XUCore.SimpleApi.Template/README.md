# XUCore.SimpleApi.Template

XUCore.SimpleApi.Template（只使用插件化的框架，不使用集成式框架）
...
dotnet new --install XUCore.SimpleApi.Template::2.0.3
...
dotnet new xucore-simpleapi-template -n MyTest -o .

```

这里的 `xucore-simpleapi-template` 是使用模板短名称。
