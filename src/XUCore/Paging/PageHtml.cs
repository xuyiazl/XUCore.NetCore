...
namespace XUCore.Paging
{
    ...
    public static class PageHtml
    {
        ...
        public static string BuildPageHtml<T>(this PagedModel<T> model, Func<int, string> urlBuilder)
        {
            ...
            return Build(model.CurrentPage, model.TotalPages, urlBuilder);
        }
        /// <summary>
        /// web 分页HTML
        /// </summary>
        ...
        public static string BuildPageHtml<T>(this PagedModel<T> model, bool showFirstAndLastPage, Func<int, string> urlBuilder)
        {
            ...
            return Build(model.CurrentPage, model.TotalPages, showFirstAndLastPage, urlBuilder);
        }
        /// <summary>
        /// web 分页HTML
        /// </summary>
        ...
        public static string BuildPageHtml<T>(this PagedModel<T> model, int numberPagesToDisplay, bool showFirstAndLastPage, Func<int, string> urlBuilder)
        {
            ...
            return Build(model.CurrentPage, model.TotalPages, numberPagesToDisplay, showFirstAndLastPage, PagerLanguage.Default, urlBuilder);
        }
        /// <summary>
        /// web 分页HTML
        /// </summary>
        ...
        public static string BuildPageHtml<T>(this PagedModel<T> model, int numberPagesToDisplay, bool showFirstAndLastPage, PagerLanguage language, Func<int, string> urlBuilder)
        {
            ...
            return Build(model.CurrentPage, model.TotalPages, numberPagesToDisplay, showFirstAndLastPage, language, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, Func<int, string> urlBuilder)
        {
            return Build(currentPage, totalPages, 7, "current", string.Empty, true, PagerLanguage.Default, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, bool showFirstAndLastPage, Func<int, string> urlBuilder)
        {
            return Build(currentPage, totalPages, 7, "current", string.Empty, showFirstAndLastPage, PagerLanguage.Default, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, int numberPagesToDisplay, bool showFirstAndLastPage, PagerLanguage language, Func<int, string> urlBuilder)
        {
            return Build(currentPage, totalPages, numberPagesToDisplay, "current", string.Empty, showFirstAndLastPage, language, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, int numberPagesToDisplay,
        ...
        {
            Pager pager = new Pager(currentPage, totalPages,
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, Func<int, UrlBuilder> urlBuilder)
        {
            return Build(currentPage, totalPages, 7, "current", string.Empty, true, PagerLanguage.Default, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, bool showFirstAndLastPage, Func<int, UrlBuilder> urlBuilder)
        {
            return Build(currentPage, totalPages, 7, "current", string.Empty, showFirstAndLastPage, PagerLanguage.Default, urlBuilder);
        }
        ...
        /// <param name="urlBuilder">url规则</param>
        /// <returns></returns>
        public static string Build(int currentPage, int totalPages, int numberPagesToDisplay, bool showFirstAndLastPage, PagerLanguage language, Func<int, UrlBuilder> urlBuilder)
        {
            return Build(currentPage, totalPages, numberPagesToDisplay, "current", string.Empty, showFirstAndLastPage, language, urlBuilder);
        }
