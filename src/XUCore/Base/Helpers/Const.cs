...
namespace XUCore.Helpers
{
    ...
    public static class Const
    {
        ...
        #endregion ChinesePinYin(汉字及拼音首字母)
        ...
        #endregion SimplifiedChinese(常用简体字汉字)
        ...
        #endregion FileExtensionDict(文件扩展类型字典)
        ...
        #endregion TimeFormatIso8601(时间格式化：ISO8601标准时间)
