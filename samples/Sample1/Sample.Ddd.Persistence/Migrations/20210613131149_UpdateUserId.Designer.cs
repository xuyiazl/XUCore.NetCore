...
namespace Sample.Ddd.Persistence.Migrations
{
    ...
    [Migration("20210613131149_UpdateUserId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminMenuEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminRoleMenuEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminUserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminUserRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.LoginRecordEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminRoleMenuEntity", b =>
                {
                    b.HasOne("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminMenuEntity", "Menus")
                        .WithMany("RoleMenus")
                        .HasForeignKey("MenuId")
                        .HasConstraintName("FK_AdminAuthMenus_AdminAuthRoleMenus")
                        .IsRequired();

                    b.HasOne("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminRoleEntity", "Role")
                        .WithMany("RoleMenus")
            ...
            modelBuilder.Entity("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminUserRoleEntity", b =>
                {
                    b.HasOne("Sample.Ddd.Domain.Core.Entities.Sys.Admin.AdminUserEntity", "AdminUser")
                        .WithMany("UserRoles")
